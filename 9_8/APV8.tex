...
Das Ziel des Versuchs ist es, den Zusammenhang zwischen Str\"omungsgeschwindigkeit, Viskosit\"at, Druckdifferenz und geometrischen Parametern darzustellen. Hierzu wird erstmal das Hagen-Poiseuille Gesetz durch Messung der Volumenstromst\"arke durch verschiedene Kapillare \"uberpr\"uft, und dann die Viskosit\"at von Wasser bestimmt.

\section{Teil 1}

\subsection{Theorie}

Ist eine laminare Str\"omung vorhanden, so gilt f\"ur die Volumenstromst\"arke $I_V$ das Hagen-Poiseuille Gesetz:
...
Aus
$$F_2 = F_G = m \vec g =\rho_w V \vec g = \rho_w A h \vec{g}$$
...
$$\Delta p = \frac{\rho_w A h \vec{g}}{A} = \rho_w h \vec{g}$$
