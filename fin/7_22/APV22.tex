...
\halftime{5}{5}{Es wurde ein Kreiselrad mit verstellbarer Kreiselachse verwendet. Dieses wurde auf ein Stativ mit einer drehbaren Halterung gesetzt, das dem Kreisel ermöglichte, eine Präzessionsbewegung zu durchlaufen. Eine Federwaage wurde verwendet um die Masse des Kreisels zu bestimmen. Es wurden zwei Stoppuhren benutzt, um jeweils die Präzessionsfrequenz und die Rotationsfrequenz zu messen. 
