...
Aufgrund eines Messfehlers, aufgrund dessen die Messung zwischen der Temperaturmessung des warmen Wassers und des Kalorimeters unterbrochen wurde, wurde angenommen, dass ein 15\,s Zeit zwischen den Messungen stattfand.

Mithilfe von (\ref{abc1}) bekommen wir zwei Ergebnisse f\"ur $t_0$. Das gr\"o\ss ere Ergebnisse ist klar das sinnvollere, da REASONING.

Unser $T_M$ liegt also bei ($59\pm2$)\celsius.
...
Um aus der Mischtemperatur die W\"armekapazit\"at des Kalorimeters zu bestimmen, wird die Formel (\ref{ck2}) verwendet.
...
\]
Mit $T_M$ die Mischungstemperatur, $T_F$ die Temperatur der Fl\"ussigkeit und $T_K$ die Temperatur des Festk\"orpers.
